...
{
    class WebMapItem: IPortalItem, IContainerItem<IPortalItem>
    {
        ...
        public WebMapItem(string name, string url)
        {
            base.name = name;
            base.url = url;
            layers = new List<IPortalItem>();
        }
        public WebMapItem(string name, string url, bool requireToken)
        {
            base.name = name;
            base.url = url;
            layers = new List<IPortalItem>();
